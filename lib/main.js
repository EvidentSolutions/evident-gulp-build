...
exports.registerTasks = function(gulp) {
    require('./browserify-compile').registerTasks(gulp);
    require('./serve').registerTasks(gulp);
    require('./styles').registerTasks(gulp);
    require('./testing').registerTasks(gulp);
    require('./typescript').registerTasks(gulp);
    require('./views').registerTasks(gulp);
    require('./watch').registerTasks(gulp);
