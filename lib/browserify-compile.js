...
function compileAppJs(targetName, watch, includeExternalLibraries) {
...
defineTask('browserify:watch', ['browserify:compile-libs'], function () {
    return compileAppJs('app.js', true, false);
});

defineTask('browserify:compile-app', ['init', 'browserify:compile-libs', 'angular-templates:build'], function () {
    return compileAppJs('app.js', false, false);
});

defineTask('browserify:bundle', ['init', 'angular-templates:build'], function () {
    return compileAppJs('bundle.js', false, true);
});

defineTask('browserify:build', function () {
    return gulp.start(settings.browserify.singleBundle ? 'browserify:bundle' : 'browserify:compile-app');
});
