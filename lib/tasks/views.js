...
exports.registerTasks = function(gulp) {
    ...
    gulp.task('views:handlebar-templates:build', ['init'], function () {
    ...
    gulp.task('views:angular-templates:build', ['init'], function () {
    ...
    gulp.task('views:watch', ['views:build'], function () {
        return gulp.watch(paths.handlebarsViews, ['views:handlebar-templates:build']);
    });

    gulp.task('views:build', ['views:handlebar-templates:build', 'views:angular-templates:build']);
};
