...
defineTask('browserify:compile-libs', function () {
...
function compileAppJs(targetName, watch) {
    // TODO: allow customization of the environment parameters
    var env = {
...
defineTask('browserify:bundle', ['angular-templates:build'], function () {
